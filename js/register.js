var Register = {
    ...
    init: function() {
        TG.init();
        API.init(); // ✅ Инициализируем с правильным токеном
    ...
    validate: function() {
        switch(this.step) {
            ...
            case 2: {
                ...
                if (!val || val < 14 || val > 80) { this.shake(); return false; }
                this.data.age = val;
                return true;
            }
            case 3: {
